...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            <form action="{{ route('admin.congtrinh.edit', $id) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="form-group">
                    <label>Tên công trình</label>
                    <input class="form-control" name="name" placeholder="Vui lòng nhập tên công trình" required value="{{ $name }}"/>
                </div>
                <div class="form-group">
