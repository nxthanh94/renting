        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Danh sách danh mục chuyên mục chiếu sáng
                </h1>
                @if( Session::get('msg') != '')
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <?php
                    ...
                    $urlDel  = route('admin.dichvu.del', $id);
                    $urlEdit = route('admin.dichvu.edit', $id);
                    $urlCT = route('admin.dichvu.chitiet', $id);
                ?>
                    <tr class="odd gradeX" align="center">
                        <td>{{ $id }}</td>
                        <td><a href="{{ $urlCT }}">{{ $dname }}</a></td>
                        <td>{{ $lname }}</td>
                        <td>{{ $date }}</td>
                        <td>
                            @if($hinhanh != '')
