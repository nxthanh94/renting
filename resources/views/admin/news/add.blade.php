        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            ...
            {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <input class="form-control" name="name" placeholder="Vui lòng nhập tên tin tức ( ENG )" required /><br />
                    <input class="form-control" name="name_vn" placeholder="Vui lòng nhập tên tin tức ( VN )" required />
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    <label>Mô tả</label>
                    <input class="form-control" name="mota" placeholder="Vui lòng nhập mô tả ( ENG )" required /><br />
                    <input class="form-control" name="mota_vn" placeholder="Vui lòng nhập mô tả ( VN )" required />
                </div>
                <div class="form-group">
