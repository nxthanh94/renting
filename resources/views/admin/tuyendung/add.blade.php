...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-7" style="padding-bottom:120px">
            <form action="{{ route('admin.tuyendung.add') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="form-group">
                    <label>Tên tin</label>
                    <input class="form-control" name="name" placeholder="Vui lòng nhập tên tin " required />
                </div>
                <div class="form-group">
