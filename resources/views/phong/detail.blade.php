...
<div id="printableArea">
             <div style="border: 1px solid #dddddd; padding:3px;background-color: #ffffff;    border-radius: 3px;    transition: all 0.2s ease-in-out;">
              ...
              <span class="area"><strong>@if($thoihan == 1) Long term @else Short term @endif</strong></span>         <span class="parking"><span style="font-weight:bold;color:#ff0000;">${{$gia}}</span> /month</span>
              <span class="area"><strong>{{$rong}}</strong><span class="visible-xs"></span>m<sup style="font-size:8px;">2</sup></span>               <span class="baths"><strong>{{$phong}}</strong><span class="visible-xs"></span> Baths</span>
              <span class="beds"><strong>{{$giuong}}</strong><span class="visible-xs"></span>Beds</span>
        ...
        {!!$ChitietDM!!}
                  ...
                  <div id="amenities" class="tab-pane">
                        ...
                        <ul class="navailable">
                          ...
                          <li><input checked type="checkbox" name="amenities" value="40"></input><span class="available"><!-- <i class="fa fa-check-square"></i> <img src="checkmark.png">--> {{$DM['name']}}</span></li>
                          @endforeach
