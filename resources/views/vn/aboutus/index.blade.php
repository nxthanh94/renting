...
<?php
  $name = $arGT['name_vn'];
  $content = $arGT['content_vn'];
  $content1 = $arGT['content1_vn'];
  $content2 = $arGT['content2_vn'];
  $content3 = $arGT['content3_vn'];
  $content4 = $arGT['content4_vn'];
  $content5 = $arGT['content5_vn'];
  $content6 = $arGT['content6_vn'];
?>
<h3 class="">{{$name}}</h3>
<p class="">{!!$content!!}</p>
</div>
<div class="col-md-6 " >
<h3 class="">Tại sao bạn nên chọn dịch vụ của chúng tôi</h3>
<div class="accordion" id="accordionsb">
<div class="accordion-group panel">
<div class="accordion-heading accordionize"> <a class="accordion-toggle active" data-toggle="collapse" data-parent="#accordionsb" href="#sb0">  Chúng tôi cung cấp dịch vụ chuyên nghiệp<br />
...
<div class="accordion-heading accordionize"> <a class="accordion-toggle " data-toggle="collapse" data-parent="#accordionsb" href="#sb1">  Đại lý thân thiện<br />
 <i class="fa fa-angle-down"></i> </a> </div>
...
<div class="accordion-group panel">
<div class="accordion-heading accordionize"> <a class="accordion-toggle " data-toggle="collapse" data-parent="#accordionsb" href="#sb2">  Thông báo cho khoản thanh toán tiền thuê của bạn<br />
 <i class="fa fa-angle-down"></i> </a> </div>
...
<div class="accordion-group panel">
<div class="accordion-heading togglize"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#" href="#ss0"> Khách hàng của chúng tôi là ai?<br />
...
<div class="accordion-group panel">
<div class="accordion-heading togglize"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#" href="#ss1"> Chúng tôi có bất kỳ chứng nhận bất động sản nào không?  <i class="fa fa-plus-circle"></i> <i class="fa fa-minus-circle"></i> </a> </div>
<div id="ss1" class="accordion-body collapse">
              <div class="accordion-inner">{!!$content5!!}</div>
            </div>
</div>
<div class="accordion-group panel">
<div class="accordion-heading togglize"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#" href="#ss2">  Bạn sẽ gửi khiếu nại về dịch vụ của chúng tôi ở đâu? <i class="fa fa-plus-circle"></i> <i class="fa fa-minus-circle"></i> </a> </div>
...
@endsection
@section('title')
Về chúng tôi - Villa | Apartment | House | Hotel | Vocation Rentals | Room for Rent in Danang
@endsection