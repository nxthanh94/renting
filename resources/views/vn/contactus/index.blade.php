...
<div id="contact51" class ="property_container" style="display:none;"><span class ="property_address">{{$name8}}</span><span class ="latitude">16.0669313</span><span class ="longitude">108.22395529999994</span><span class ="property_image_url">{{ $url_public }}/images/map-marker.png</span></div>              </div>
          <div class="share-bar">
...
@endsection
@section('title')
Liên hệ - Villa | Apartment | House | Hotel | Vocation Rentals | Room for Rent in Danang
@endsection