            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-calendar"></i> Danh mục bất động sản<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-calendar"></i> Danh sách phòng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
